...
DaXianConstellationPassageInfo _$DaXianConstellationPassageInfoFromJson(
  ...
  startDegreeInConstellation: (json['startDegreeInConstellation'] as num)
      .toDouble(),
  endDegreeInConstellation: (json['endDegreeInConstellation'] as num)
      .toDouble(),
  segmentAngularSpanDegrees: (json['segmentAngularSpanDegrees'] as num)
      .toDouble(),
  ...
  constellationStarInfluences:
      (json['constellationStarInfluences'] as List<dynamic>?)
          ?.map(
            (e) => ConstellationStarInfluenceModel.fromJson(
