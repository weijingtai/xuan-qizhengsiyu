...
DaXianGong _$DaXianGongFromJson(Map<String, dynamic> json) => DaXianGong(
  ...
  totalYears: YearMonth.fromJson(json['totalYears'] as Map<String, dynamic>),
);
...
DaXianFeiXianGong _$DaXianFeiXianGongFromJson(Map<String, dynamic> json) =>
    DaXianFeiXianGong(
      ...
      totalYears: YearMonth.fromJson(
        json['totalYears'] as Map<String, dynamic>,
      ),
    );
...
DongWeiFate _$DongWeiFateFromJson(Map<String, dynamic> json) => DongWeiFate(
  type: $enumDecode(_$DongWeiDaXianMingGongCountingTypeEnumMap, json['type']),
