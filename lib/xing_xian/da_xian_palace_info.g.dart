...
DaXianPalaceInfo _$DaXianPalaceInfoFromJson(
  Map<String, dynamic> json,
) => DaXianPalaceInfo(
  order: (json['order'] as num).toInt(),
  palace: $enumDecode(_$EnumTwelveGongEnumMap, json['palace']),
  durationYears: YearMonth.fromJson(
    json['durationYears'] as Map<String, dynamic>,
  ),
  ...
  constellationPassages: (json['constellationPassages'] as List<dynamic>)
      .map(
        (e) =>
            DaXianConstellationPassageInfo.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  ...
  dingStarMapper: (json['dingStarMapper'] as Map<String, dynamic>?)?.map(
    (k, e) => MapEntry(
      ...
      (e as List<dynamic>)
          .map(
            (e) => DingStarInfluenceModel.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    ),
  ),
  xingXianType:
      $enumDecodeNullable(_$EnumXingXianTypeEnumMap, json['xingXianType']) ??
...
Map<String, dynamic> _$DaXianPalaceInfoToJson(DaXianPalaceInfo instance) =>
    <String, dynamic>{
      ...
      'dingStarMapper': instance.dingStarMapper?.map(
        (k, e) => MapEntry(_$EnumInfluenceTypeEnumMap[k]!, e),
      ),
...
StarGongInfluence _$StarGongInfluenceFromJson(
  Map<String, dynamic> json,
) => StarGongInfluence(
  sameGongInfluence: (json['sameGongInfluence'] as List<dynamic>?)
      ?.map((e) => PalaceStarInfluenceModel.fromJson(e as Map<String, dynamic>))
      .toList(),
  ...
  triangleGongInfluence:
      (json['triangleGongInfluence'] as Map<String, dynamic>?)?.map(
        (k, e) => MapEntry(
          ...
          (e as List<dynamic>)
              .map(
                (e) => PalaceStarInfluenceModel.fromJson(
  ...
  squareGongInfluence: (json['squareGongInfluence'] as Map<String, dynamic>?)
      ?.map(
        (k, e) => MapEntry(
          $enumDecode(_$EnumTwelveGongEnumMap, k),
          (e as List<dynamic>)
  ...
  sameLuoInfluence: (json['sameLuoInfluence'] as Map<String, dynamic>?)?.map(
    (k, e) => MapEntry(
      $enumDecode(_$EnumTwelveGongEnumMap, k),
      (e as List<dynamic>)
          .map(
            (e) => PalaceStarInfluenceModel.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    ),
  ),
...
Map<String, dynamic> _$StarGongInfluenceToJson(StarGongInfluence instance) =>
    <String, dynamic>{
      ...
      'triangleGongInfluence': instance.triangleGongInfluence?.map(
        (k, e) => MapEntry(_$EnumTwelveGongEnumMap[k]!, e),
      ),
      'squareGongInfluence': instance.squareGongInfluence?.map(
        (k, e) => MapEntry(_$EnumTwelveGongEnumMap[k]!, e),
      ),
      'sameLuoInfluence': instance.sameLuoInfluence?.map(
        (k, e) => MapEntry(_$EnumTwelveGongEnumMap[k]!, e),
      ),
    };
