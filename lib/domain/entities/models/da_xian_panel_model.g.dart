...
DaXianPanelModel _$DaXianPanelModelFromJson(Map<String, dynamic> json) =>
    DaXianPanelModel(
      ...
      enteredGongMapper: (json['enteredGongMapper'] as Map<String, dynamic>)
          .map(
            (k, e) => MapEntry(
              $enumDecode(_$EnumStarsEnumMap, k),
...
Map<String, dynamic> _$DaXianPanelModelToJson(
  DaXianPanelModel instance,
) => <String, dynamic>{
  ...
  'shenShaMapper': instance.shenShaMapper.map(
