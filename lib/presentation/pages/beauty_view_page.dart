...
import '../widgets/lunar_date_info_card_v2.dart';
...
class _BeautyViewPageState extends State<BeautyViewPage>
                ...
                children: [
                  TextSpan(
                    ...
                    style: infoTextStyle.copyWith(
                      color: _palette.zhengColor(bodyLifeModel.lifeGong.sevenZheng),
                    ),
                  ),
                ],
              ),
              ...
              TextSpan(
                ...
                children: [
                  TextSpan(
                    ...
                    style: infoTextStyle.copyWith(
                      color: _palette.zhengColor(bodyLifeModel.lifeConstellation.sevenZheng),
                    ),
                  ),
                ],
              ),
              ...
              TextSpan(
                ...
                children: [
                  TextSpan(
                    ...
                    style: infoTextStyle.copyWith(
                      color: _palette.zhengColor(bodyLifeModel.bodyGong.sevenZheng),
                    ),
                  ),
                ],
              ),
              ...
              TextSpan(
                ...
                children: [
                  TextSpan(
                    ...
                    style: infoTextStyle.copyWith(
                      color: _palette.zhengColor(bodyLifeModel.bodyConstellation.sevenZheng),
                    ),
                  ),
                ],
              ),
  ...
  Widget panel(double starBodyRadius) {
    ...
    List<Text> zodiacTextList = zodiacList
        .map((e) => Text(e, style: zodiacTextStyle))
        .toList();
    ...
    List<Text> starSeqTextList = starSeqList
        .map((e) => Text(e, style: starTextStyle))
        .toList();
    // 命理十二宫 从命宫开始
  ...
  Widget lifePanelStar(
    ...
    Color backgroundColor =
        _palette.starsColorMap[star.star]!;
    double oWidth = offsetWidth;
    if (offsetWidthTimes != 0) {
      if (offsetWidthTimes < 0) {
        int owt = offsetWidthTimes * -1;
  ...
  void selectTaiJiDestinyByGongName(String selectedGongName) {
    ...
    List<String> tmpDestinyList = _destiny12GongListNotifier.value
        .map((d) => d)
        .toList();
